...
void inicializar_opcion(Enemigo enemigos[][2]){
    ...
    Opcion opcion2_3; 
    init_opcion(&opcion2_3,"Luchar","No te has encontrado con ningún enemigo",NULL,0,"Consigues llegar al lago sin pelear con nadie");
...
void inicializar_decision(Opcion opciones[][3]){
    ...
    Decision decision3;
    init_decision(&decision3, "¿Cuál camino vas a coger?", opciones[2], 2);
